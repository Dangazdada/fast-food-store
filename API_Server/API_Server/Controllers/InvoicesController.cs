...
namespace API_Server.Controllers
{
    ...
    public class InvoicesController : ControllerBase
    {
        ...
        {
            var invoice = await _context.Invoices.Include(p => p.OrderStatus)
        ...
        public async Task<IActionResult> PutInvoice(int id, int orderStatus)
        {
           
            var invoice = await _context.Invoices.FindAsync(id);
            invoice.OrderStatusId = orderStatus;
