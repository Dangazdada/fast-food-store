...
namespace API_Server.Controllers
{
    ...
    public class ComboesController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        [Authorize(Roles = "Admin")]
        public async Task<ActionResult<Combo>> PutCombo(int id,string imgaeId, [FromForm] Combo pFrom)
        {
            ...
            combo.ProductTypeId = pFrom.ProductTypeId;
            combo.Name = pFrom.Name;
          
            combo.Price = pFrom.Price;
            combo.Status = pFrom.Status;
         
            if (pFrom.ImageFile != null && pFrom.ImageFile.Length > 00)
            {
                ...
                var image = await _context.Images.FindAsync(imgaeId);
                image.ImageId = 10;
